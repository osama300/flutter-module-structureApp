...
class __$$CancelledImplCopyWithImpl<T, $Res>
    extends _$ApiStateCopyWithImpl<T, $Res, _$CancelledImpl<T>>
...
class _$CancelledImpl<T> implements Cancelled<T> {
  const _$CancelledImpl();

  @override
  String toString() {
    return 'ApiState<$T>.cancelled()';
  }
...
abstract class Cancelled<T> implements ApiState<T> {
